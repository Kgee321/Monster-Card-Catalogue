""" Component 4 -- Combining add and search functions (version 1)
Adding in main recyclable function for search() and
main recyclable function for edit() to use them together.
Making small changes to both functions so the codes link
nicely together. Also keeping in mind that any changes
to the edit function to be suit the add() in the file
05_edit_card_function_v1
Written by Katelyn Gee
Created on the 16/05/2023
"""
